...
4. Use the source's safe state. Otherwise stop motion normally, remove filament only when directed, power off, unplug, and let hot parts cool. The K2 manual says to wait at least 30 minutes after switch-off before touching hot parts. [P003]
