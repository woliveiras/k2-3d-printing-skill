...
Read only the file needed for the decision.

| Task | Reference |
|---|---|
| Gather constraints and choose a profile objective | [Decision workflow](decision-workflow.md) |
| Balance finish, speed, strength, time, and material | [Quality, speed, and strength](quality-speed-strength.md) |
| Orient parts; choose normal/tree supports, interfaces, brim, raft, or ears | [Orientation and supports](orientation-and-supports.md) |
| Calibrate a printer/material/nozzle/plate combination | [Calibration](calibration.md) |
